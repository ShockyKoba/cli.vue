            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table mt-5 mb-0 table-striped table-bordered">
                            <thead>
                                <tr class="thead-dark">
                                    <th>#</th>
                                    <th>Fruit</th>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="row">
                            <div class="col-12" v-if="newfruit_display_error.length">
                                <b>Porfavor corrija los siguientes errores: </b>
                                <ul>
                                    <li v-for="error of newfruit_display_error">
                                        {{error.error_name}}
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-12 col-sm-3">
                                <label class="mb-3">
                                    <button type="button" @click="AddFruit()" class="btn btn-primary">Add Fruit</button>
                                </label>
                            </div>
                        </div>
                    </div>
